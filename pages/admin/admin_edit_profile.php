...
if(isset($_POST['update'])){
    ...
    if(count($errors) == 0){
        ...
        $query = 'UPDATE teacher SET first_name="'.$first_name.'",last_name="'.$last_name.'",email="'.$email.'",phone="'.$phone.'",profile_img="'.$finalImage.'" WHERE username="'.$teacherID.'";';
        $data = mysqli_query($db, $query);
        if($data){
            $_SESSION['profileImg'] = $finalImage;
...
<div class="row">
    ...
    <div class="column">
        <img style="width:600px; height:auto;"src='<?php $imgPath = ($_SESSION['profileImg']) ? ($mainPage."uploads/users/profile-picture/".$_SESSION['profileImg']) : $mainPage."res/avatar.png"; echo $imgPath; ?>' alt="Avatar Image" style="width:100%">  
    </div>
    <div class="column">
            <?php
                echo $editFORM;
