...
<div class="float">
 ...
 <div class="row">
        <img src='res/gces1.jpg' alt="GCES" >  
            </div>


<div class= "contents">
    <p class="mid"> Gandaki College of Engineering and Science</p>
<p class="head2">About Us</p>

<p class="desc2">The Gandaki College of Engineering and Science (GCES) is an independent non-profit institution 
    ...
    climate all the years round and refreshing panoramic view of the snow-capped Himalayas in the front.
     In 1998, with the genuine effort of Dr. PV Chandy, the then Principal of GBS/GCES, GCES was founded as an 
     extension to GBS with the approval of the GBS board and the United Mission to Nepal (UMN). 
     It is managed by the UMN GB. GCES Public Education Trust. 
...
<p class="head2"> Mission And Vision </p>

<p class="desc2"> GCES strongly feels that development is only possible with quality education and hence 
